...
public class MyVideosAdapter extends RecyclerView.Adapter<MyVideosAdapter.QVHolder> {
        ...
        final Runnable mLongPressed = new Runnable() {
            public void run() {
                ...
                DraweeController controller = Fresco.newDraweeControllerBuilder()
                        ...
                        .build();
                ProfileFragment.gifView.setController(controller);
                ProfileFragment.gifView.setVisibility(View.VISIBLE);
            }
        };
...
//                    dialog.dismiss();
                    ...
                    ProfileFragment.gifView.setVisibility(View.INVISIBLE);
                    return true;
